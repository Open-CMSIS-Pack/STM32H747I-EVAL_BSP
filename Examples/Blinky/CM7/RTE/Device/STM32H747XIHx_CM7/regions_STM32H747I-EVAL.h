#ifndef REGIONS_STM32H747I_EVAL_H
#define REGIONS_STM32H747I_EVAL_H
...
// <i> Board Support Pack (BSP):   Keil::STM32H747I-EVAL_BSP@1.0.0
...
// <h> RAM Configuration
// =======================
// <h> __RAM0 (is rw memory: DTCMRAM from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
// <h> __RAM1 (is rw memory: RAM_D1 from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
// <h> __RAM2 (is rw memory: RAM_D3 from DFP)
//   <o> Base address <0x0-0xFFFFFFFF:8>
...
#endif /* REGIONS_STM32H747I_EVAL_H */
